...
- **date**: 2025-10-07 16:19:19
- **task**: profile
- **vars_to_scan**: OrderedDict{Any, Any}(:θ₂₃ => 21, :Δm²₃₁ => 21)
- **commit_hash**: f817612e8037785e61fc8bf41f4ee286028e5e9c
- **priors**: (nc_norm = 1.0, nutau_cc_norm = 1.0, Δm²₂₁ = 7.53e-5, Δm²₃₁ = Uniform{Float64}(a=0.002, b=0.003), δCP = 1.0, θ₁₂ = 0.5872523687443223, θ₁₃ = Truncated(Normal{Float64}(μ=0.156, σ=0.008); lower=0.13, upper=0.18), θ₂₃ = Uniform{Float64}(a=0.5235987755982988, b=1.0471975511965976))
